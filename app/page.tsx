      ...
      <main className="flex flex-col gap-8 row-start-2 items-left sm:items-start">
        ...
        <section id="education" className="flex flex-col gap-6 sm:gap-8">
          ...
          <div className="w-full sm:w-2/3 px-4">
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-4 gap-6 px-6">
        ...
        <section id="experience">
          <h1 className="font-bold text-4xl py-3"> Recent Experiences </h1>
        ...
        <section id="projects">
          <h1 className="font-bold text-4xl py-3"> Recent Projects </h1>
