...
const eduPage = () => {
  ...
  <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-4 xl:grid-cols-7 gap-3 gap-x-2 sm:gap-4">
    ...
    <div className="relative group">
      ...
      <div className="flex justify-center items-center text-white text-sm font-bold">Languages</div>
      <div className="absolute inset-0 flex flex-wrap items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
    ...
    <div className="relative group">
      <div className="absolute inset-0 bg-opacity-0 group-hover:bg-opacity-40 bg-black transition-all duration-300"></div>
      <div className="flex justify-center items-center text-white text-sm font-bold">AI & Machine Learning</div>
      <div className="absolute inset-0 flex flex-wrap items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
    ...
    <div className="relative group">
      <div className="absolute inset-0 bg-opacity-0 group-hover:bg-opacity-40 bg-black transition-all duration-300"></div>
      <div className="flex justify-center items-center text-white text-sm font-bold">Data Analysis</div>
      <div className="absolute inset-0 flex flex-wrap items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
    ...
    <div className="relative group">
      <div className="absolute inset-0 bg-opacity-0 group-hover:bg-opacity-40 bg-black transition-all duration-300"></div>
      <div className="flex justify-center items-center text-white text-sm font-bold">General Skills</div>
      <div className="absolute inset-0 flex flex-wrap items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
